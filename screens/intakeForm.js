...
const intakeSchema = yup.object({
	appTeamContactInfo     : yup.string().required('Team Contact is a required field'),
	...
	appIdentifier          : yup.string().required('Application Identifier is a required field'),
	authMethod             : yup.string().required('Authentication Method is a required field'),
	vpnTunnelNeeded        : yup.string().required('VPN Tunnel is a required field'),
	networkAccessRequired  : yup.string().required('Network Access Required is a required field'),
	networkPorts           : yup.string().required('Network Ports is a required field'),
	targetDeviceModels     : yup.string().required('Target Device Models is a required field'),
	securityScansCompleted : yup.string().required('What Security Scans Completed is a required field'),
	...
	numberOfEndUsers       : yup.number().required('Number of End Users is a required field'),
	mandatoryApplication   : yup.string().required('Application Mandatory is a required field'),
	addedSecurityStandards : yup.string().required('Security Standard Added is a required field')
});
